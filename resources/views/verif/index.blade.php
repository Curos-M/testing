      ...
      $.ajax({
        ...
        success: function(data){
          ...
          if( winWidth <= 1199){
            ...
            "<div class='col-md-12'>"+
              "<div class='row'>"+
                "<span class='col-md-4 mb-3'>Nomor Induk Kependudukan"+"</span><span>:</span><span class='col-md-7'> "+nik+"</span>"+
                "<span class='col-md-4 mb-3'>Nama Lengkap"+"</span><span>:</span><span class='col-md-7'> "+data.nama_lengkap+"</span>"+
                "<span class='col-md-4 mb-3'>Nama Panggilan"+"</span><span>:</span><span class='col-md-7'> "+data.nama_panggilan+"</span>"+
                "<span class='col-md-4 mb-3'>Tempat, Tanggal Lahir"+"</span><span>:</span><span class='col-md-7'> "+data.tempat_lahir+", "+data.tanggal_lahir_raw+"</span>"+
